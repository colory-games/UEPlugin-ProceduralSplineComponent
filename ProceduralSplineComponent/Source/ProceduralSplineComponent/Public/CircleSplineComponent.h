...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Circle Spline Component", meta = (ClampMin = 3))
	int32 PointNum = 30;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Circle Spline Component", meta = (ClampMin = 0.0f))
	float Radius = 500.0f;
};